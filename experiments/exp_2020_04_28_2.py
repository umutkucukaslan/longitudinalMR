...
EXPERIMENT_NAME = 'exp_2020_04_28_2'
...
if __name__ == "__main__":
    ...
    def generator_loss(gen_output, target, disc_generated_output=None):
        gen_l1_loss = l1_loss(target, gen_output)
        return gen_l1_loss
    ...
    def train_step(input_image, target):
        with tf.GradientTape() as gen_tape, tf.GradientTape() as disc_tape:
            ...
            gen_l1_loss = generator_loss(gen_output, target, disc_generated_output)
        ...
        for epoch in range(initial_epoch, num_epochs):
            ...
            for n, input_image in train_ds.enumerate():
                if TRAIN_ADVERSARIALLY:
                    gen_l1_loss, disc_loss = train_step(input_image, input_image)
                    losses[0].append(0)
                    losses[1].append(0)
            ...
            for input_image in val_ds:
                if TRAIN_ADVERSARIALLY:
                    gen_l1_loss, disc_loss = eval_step(input_image, input_image)
