...
from experiments.exp_2020_04_28 import get_encoder_decoder_generator_discriminator
...
for img_paths, title in cases:
    ...
    std_mse = round(std_mse, 3)

    plt.figure()
    figure_path = os.path.join(EXPERIMENT_FOLDER, 'testing', title + '_ssim.jpg')
    ...
    plt.figure()
    figure_path = os.path.join(EXPERIMENT_FOLDER, 'testing', title + '_mse.jpg')
